@echo off
start .\..\ManagementCenter\ManagementCenter\bin\Debug\ManagementCenter.exe ".\..\sharedResources\tsst_config_alpha_v1.xml" ".\..\sharedResources\tsst_config_alpha_v2.xml"
