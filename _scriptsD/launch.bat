...
ping 192.0.2.2 -n 1 -w 200 > nul
start .\..\ClientNode\ClientNode\bin\Debug\ClientNode.exe ".\..\sharedResources\tsst_config.xml" "5"
ping 192.0.2.2 -n 1 -w 200 > nul
start .\..\ClientNode\ClientNode\bin\Debug\ClientNode.exe ".\..\sharedResources\tsst_config.xml" "6"
ping 192.0.2.2 -n 1 -w 200 > nul
start .\..\ClientNode\ClientNode\bin\Debug\ClientNode.exe ".\..\sharedResources\tsst_config.xml" "7"
ping 192.0.2.2 -n 1 -w 200 > nul
